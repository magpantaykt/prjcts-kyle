...
//() beside functionName could be empty if the function doesnt need parametere
...
function getDivisibility(){
	...
	let numA = 10; //let - values can be updated 
	const numB = 2; //const - values cannot be reassigned

	let remainder = numA%numB;

	console.log('Remainder of 10/2:',remainder);
	console.log('is 10 divisible by 2:',remainder===0);
}
...
let divisibilityFunction = function (){
